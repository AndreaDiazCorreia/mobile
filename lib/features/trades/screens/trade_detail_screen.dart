...
class TradeDetailScreen extends ConsumerWidget {
            ...
            child: Column(
              children: [
                ...
                if (isPending && isCreator) ...[
                  _buildCreatorReputation(tradeState, context),
                  const SizedBox(height: 16),
                ] else ...[
  ...
  Widget _buildSellerAmount(
      ...
      return Column(
        children: [
          NotificationMessageCard(
            message: S.of(context)!.youCreatedThisOffer,
    ...
    return Column(
      children: [
        OrderAmountCard(
          title: isSellingRole
              ? S.of(context)!.youAreSelling
              : S.of(context)!.youAreBuying,
          amount: tradeState.order!.fiatAmount.toString(),
          currency: tradeState.order!.fiatCode,
          currencyFlag: currencyFlag,
          priceText: priceText,
  ...
  Widget _buildCreatorReputation(OrderState tradeState, BuildContext context) {
